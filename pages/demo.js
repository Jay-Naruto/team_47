...
export default function demo() {
  ...
  <div className={styles.navbar}>
    ...
    <div className={styles.navlinkwrap}>
      ...
      <Link href="/">
                      <a className="mr-6 text-white-800">
  ...
  <div className={styles.auction}>
    ...
    <div className={styles.nft}>
      ...
      className={styles.item}>
        ...
        href={{
                            pathname: '/details',
                            query:{ img:"https://pbs.twimg.com/media/FEtXu55WUAI9xZU.jpg:large"}
                          }}
                          as="/details">
        <img className={styles.itemimg} src="https://pbs.twimg.com/media/FEtXu55WUAI9xZU.jpg:large" alt="unsplash-OG44d93i-NJk" border="0"/>
      ...
      <Link        
        href={{
                            pathname: '/details',
                            query:{ img:"https://render.fineartamerica.com/images/rendered/medium/print/8/7/break/images-medium-5/total-knee-replacement-x-rays-zephyr.jpg"}
                          }}
                          as="/details">
      ...
      <Link        
        href={{
                            pathname: '/details',
                            query: {img:"https://www.centreforsight.net/cfs/images/blog-img/smile-eye-surgery.jpg"}
                          }}
                          as="/details">
